...
<body>
    ...
    <section class="text-white py-4 py-md-5 pt-5" style="background: linear-gradient(135deg, #2d6a5f 0%, #1f5449 100%); margin-top: 56px;">
        <div class="container py-4 py-md-5 text-center">
            <h1 class="fw-bold mb-3" style="font-size: clamp(2rem, 5vw, 3.5rem);">Kegiatan Warga</h1>
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 border-0 shadow-sm hover-shadow overflow-hidden">
                                <?php
                                $thumb_path = 'assets/images/kegiatan/'.$row['foto'];
                                $thumb_src = (!empty($row['foto']) && file_exists($thumb_path)) ? $thumb_path : 'assets/images/placeholder.jpg';
                                ?>
                                <img src="<?= $thumb_src ?>" class="card-img-top" alt="<?= $row['judul'] ?>" style="height: 200px; object-fit: cover;">
                                    ...
                                    <div class="modal-body p-0">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <div id="carouselKegiatan<?= $row['id'] ?>" class="carousel slide h-100" data-bs-ride="carousel">
                                                        <div class="carousel-inner h-100">
                                                            ...
                                                            <div class="carousel-item <?= $idx == 0 ? 'active' : '' ?>">
                                                                ...
                                                                <?php else: ?>
                                                                    <?php
                                                                    $galeri_path = 'assets/images/kegiatan/'.$img['file'];
                                                                    $galeri_src = (file_exists($galeri_path)) ? $galeri_path : 'assets/images/placeholder.jpg';
                                                                    ?>
                                                                    <img src="<?= $galeri_src ?>" class="d-block w-100" alt="Dokumentasi" style="height: 400px; object-fit: cover;">
                                                ...
                                                <?php else: ?>
                                                    <img src="<?= $thumb_src ?>" class="d-block w-100" style="height: 400px; object-fit: cover;">
