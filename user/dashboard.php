    ...
    <main class="main-content container py-4 mt-5 pt-5">
        ...
        <header class="d-flex justify-content-between align-items-center mb-5">
            <div>
                ...
                ?>
                <h2 class="fw-bold mb-1">Selamat Datang, <?= $sapaan ?> <?= explode(' ', $warga['nama_lengkap'])[0] ?></h2>
                    ...
                    <div class="card border-0 shadow-sm mb-4 announcement-card-modern" style="border-radius: 20px; overflow: hidden; transition: all 0.3s;">
                        <div class="row g-0">
                            <div class="col-md-4 position-relative overflow-hidden">
                                <img src="<?= !empty($row['foto']) ? '../assets/images/kegiatan/'.$row['foto'] : 'https://via.placeholder.com/400x300/134e4a/ffffff?text=Kegiatan' ?>" class="w-100 h-100" alt="<?= htmlspecialchars($row['judul']) ?>" style="object-fit: cover; min-height: 220px;">
